...
class Spritesheet(object):
    def __init__(self):
        try:
            # Load without .convert() to work in headless mode
            self.sheet = pygame.image.load("assets/images/spritesheet_mspacman.png")
...
class PacmanScriptes(Spritesheet) :
